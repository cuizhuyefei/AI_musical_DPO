...
在我心中
    ...
    The translated version is:'''        
      ...
      response_list = [s.strip() for s in response[0].split('\n') if len(s.strip())>0]
...
N2 = 0
if not use_N2: N2 = 0
filename = 'final_experiments/gpt_pure_prompt_5shot_res.json' if few_shot_prompt else 'final_experiments/gpt_pure_prompt_0shot_res.json'
print('N=', N, 'use_N2=', use_N2, 'filename=', filename)
