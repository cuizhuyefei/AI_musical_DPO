...
And virtue shall triumph at last'''
    syllables = [[3, 9], [3, 6], [3, 9], [8], [3, 4, 6], [8], [7, 6], [8], [7, 7], [12], [9], [12], [8]]
    return input_lyric, syllables
...
def YouAreNotAlone():
    input_lyric = '''Have you ever felt like nobody was there
...
Of things beyond your ken
    '''
    syllables = [[5, 5], [7], [5, 5], [7], [4, 4], [2, 4], [10], [6], [8], [6], [9], [7], [8], [6], [8], [6]]
    return input_lyric, syllables

def TheImpossibleDream():
    input_lyric = '''
...
To reach the unreachable stars!
    '''
    syllables = [[2, 6], [2, 6], [2, 7], [2, 6], [2, 6], [2, 6], [2, 7], [2, 6], [4, 5], [6, 5], [5], [6], [9], [6], [3, 6], [5], [3, 6], [6], [3, 6], [3, 6], [2, 7], [2, 6]]
    return input_lyric, syllables
...
Suddenly there's nothing in between me and the sky
    '''
    syllables = [[13], [12], [9], [15], [8], [7], [7], [8], [7], [10], [11], [11], [7], [13]]
    return input_lyric, syllables
...
and you're gonna hear them live in consort.
    '''
    syllables = [[11], [11], [13], [11], [11], [11], [3, 2], [9], [3, 6], [10], [11], [2, 8], [7], [9], [10]]
    return input_lyric, syllables
...
# Inside your mind
#     '''
    syllables = [[6], [4], [6], [4], [6], [4], [10], [4], [6], [4], [6], [4], [6], [4], [10], [4], [6], [4], [6], [4], [6, 4], [10], [4]]
    return input_lyric, syllables
...
And that's not right!
    '''
    syllables = [[4], [10], [9, 7], [10], [10], [12], [4], [11], [11], [11], [7], [6], [4]]
    return input_lyric, syllables

def generate_txt():
    songs = [AvenueQ, YouAreNotAlone, OnlyUs, IMissTheMountains, YouDontKnow, Popular, RevoltingChildren, Six, WavingThroughAWindow, Man, LetItGo, ForTheFirstTimeInForever, SixteenGoingOn17, TheImpossibleDream, MeAndTheSky, ExWives, Phantom, Matilda]
    for song in songs:
        input_lyric, syllables = song()
        song_name = song.__name__
        with open(f'lyrics/{song_name}.txt', 'w') as f:    
            f.write(input_lyric[1:])
